    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>SELAMAT DATANG DI ARSIP SURAT MASUK DAN SURAT KELUAR DI KANTOR BUPATI ASAHAN</strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">No. Surat</th><th>Nama Pihak</th><th>Tanggal Masuk</th><th>Keterangan Surat</th><th>Jenis Surat</th>
                            </tr>
                        </thead>
                        <tbody>
